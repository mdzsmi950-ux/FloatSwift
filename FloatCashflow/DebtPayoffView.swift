...
struct DebtPayoffView: View {
    ...
    private var note: some View {
        Text("Debt payments from Out sync here for payoff planning. Changes made inside this planner stay planning-only and will not change Out or your cash-flow timeline.")
            .font(.system(size: 12))
